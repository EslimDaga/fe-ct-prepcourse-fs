...
function todosIguales(array) {
  ...
  // Tu código:
  return array.filter((i) => i === array[0]).length === array.length;
}
...
function mesesDelAño(array) {
  ...
  // Tu código:
  return array.includes("Enero", "Marzo", "Noviembre")
